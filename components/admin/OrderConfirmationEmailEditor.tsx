  ...
  return (
    <div className="flex w-full max-w-xl flex-col gap-3 rounded-xl border border-border bg-background p-4 shadow-sm">
      ...
      <p className="text-xs text-muted">
        Sent automatically the moment a payment is confirmed. Use {"{{customerName}}"} anywhere
        below — it gets filled in per order. Item photos, total, and the tracking/account buttons
        are added automatically under your message.
      </p>
